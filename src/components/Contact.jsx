...
const socialLinks = [
  {
    href: "https://github.com/Merckerk",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/mrcsmarsan/",
    icon: (
      <svg
        width="24"
        height="24"
    ...
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline2 lg:max-w-[12ch]">
            Let&apos;s work together!
          </h2>
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Reach out to me for your project needs and other professional
            endeavors!
          </p>
        ...
        <form action="https://getform.io/f/bnllqkpb" method="POST" className="xl:pl-10 2xl:pl-20">
